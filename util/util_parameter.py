...
class UtilParameter:
    ...
    def read_config_default(self, file_name="config_default", file_format="json", file_type="config"):
        ...
        app_time = datetime.datetime.strftime(app_time, '%Y-%m-%d %H-%M-%S')
        self.config_menu[self.GLOBAL]["app_time"] = {
            "type": "string",
            "description": "本次运行的开始时间",
            "default": app_time
        }
        self.config[self.GLOBAL]["app_time"] = app_time
